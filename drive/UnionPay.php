...
use Pays\payment\sdk\UnionPay\AcpService;
use Pays\payment\sdk\UnionPay\SDKConfig;

class UnionPay implements \Pays\payment\core\PayInterface
{
    ...
    private function printResult($url, $req, $resp)
    {
        echo "=============<br>\n";
        echo "地址：" . $url . "<br>\n";
        echo "请求：" . str_replace("\n", "\n<br>", htmlentities(\Pays\payment\sdk\UnionPay\createLinkString($req, false, true))) . "<br>\n";
        echo "应答：" . str_replace("\n", "\n<br>", htmlentities(\Pays\payment\sdk\UnionPay\createLinkString($resp, false, false))) . "<br>\n";
        echo "=============<br>\n";
    }
}
