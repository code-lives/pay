 ...
 */
class TouTiaoPay implements \Pays\payment\core\PayInterface
{
    private $merchant_id;
    ...
    */
    ...
    public function getAppParams()
    {
        ...
        $ali = \Pays\payment\drive\PayFactory::getInstance('AliPay')
            ->init($this->aliSet)
            ->set($this->orderSn, $this->centsToYuan($this->amount), $this->title, $this->body);
        $wx = \Pays\payment\drive\PayFactory::getInstance('WeChatPay')
            ->init($this->wxSet)
            ->set($this->orderSn, $this->centsToYuan($this->amount), $this->title, $this->body);
