...
namespace Pays\payment\sdk\aliPay\wappay\service;
...
class AlipayTradeService {
	 ...
	 * @param \Pays\payment\sdk\aliPay\wappay\buildermodel\AlipayTradeWapPayContentBuilder $builder 业务参数，使用buildmodel中的对象生成。
	...
	function wapPay($builder,$return_url,$notify_url) {
		...
		$request = new \Pays\payment\sdk\aliPay\aop\request\AlipayTradeWapPayRequest();
	 ...
	 function aopclientRequestExecute($request,$ispage=false) {
		...
		$aop = new \Pays\payment\sdk\aliPay\aop\AopClient ();
